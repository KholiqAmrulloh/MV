        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container">
                    ...
                    <div class="form-group">
                        <label for="FormControlImage1" class="font-weight-bold">Image 1</label>
                        <input type="file" class="form-control-file" name="image1" id="image1">
                    </div>
                    <div class="form-group">
                        <label for="FormControlImage2" class="font-weight-bold">Image 2</label>
                        <input type="file" class="form-control-file" name="image2" id="image2">
                    </div>
                    <div class="form-group">
                        <label for="FormControlImage3" class="font-weight-bold">Image 3</label>
                        <input type="file" class="form-control-file" name="image3" id="image3">
                    </div>
                    <div class="form-group">
                        <label for="FormControlCaption1" class="font-weight-bold">Caption</label>
                        <textarea class="form-control" name="caption1" id="caption1" rows="3" placeholder="Inputkan Caption"></textarea>
                    </div>
